...
export type BlogFeaturedPostQuery = { __typename?: 'Query', post?: { __typename?: 'PostRecord', id: string, title: string, slug: string, readTime?: number | null, excerpt: string, specialPick?: string | null, _publishedAt?: string | null, hero: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', sizes: string, src: string, width: number, height: number, alt?: string | null, title?: string | null, base64?: string | null } | null } } | null };
