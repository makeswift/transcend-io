...
export type CardModelCardsField =
  | ActionCardRecord
  | InformationCardRecord
  | QuoteCardRecord
  | SourceCardRecord
  | VideoPopupCardRecord
...
export type HeaderModelDropdownLinksField =
  | ButtonsArrayRecord
  | DropdowncolumnRecord
  | LinksArrayRecord
  | SingleLinkRecord
...
export type PageModelContentField =
  | BadgesBlockRecord
  | BlogCardsGridRecord
  | CardsArrayContentBlockRecord
  | CaseStudyBlockRecord
  | CaseStudyRelatedRecord
  | CodeBlockRecord
  | CodeContentBlockRecord
  | ContactContentBlockRecord
  | ContactFormRecord
  | FaqContentBlockRecord
  | FeaturesGridRecord
  | FormContentBlockRecord
  | FullLawContentBlockRecord
  | GeneralContentBlockRecord
  | GetStartedRecord
  | GlossaryBlockRecord
  | HeroNewStyleRecord
  | HeroRecord
  | HeroWithBackgroundRecord
  | HeroWithFormRecord
  | ImageContentBlockRecord
  | ImageWith3upsContentBlockRecord
  | IntegrationContentBlockRecord
  | InvestorContentBlockRecord
  | JobsContentBlockRecord
  | LogosBlockAnimatedRecord
  | LogosBlockRecord
  | NavigationModuleRecord
  | PricingRecord
  | QuoteContentBlockRecord
  | ResourcesFeaturedRecord
  | ResourcesHeroRecord
  | ResourcesListRecord
  | ResourcesSectionRecord
  | SecurityLabelContentBlockRecord
  | SliderContentBlockRecord
  | StatsBlockRecord
  | StoriesGridContentBlockRecord
  | StoryContentBlockRecord
  | TestimonialSliderNewStyleRecord
  | TestimonialSliderRecord
  | TextContentBlockRecord
  | ThreeColumnsBlockRecord
  | VideoBlockRecord
...
export type BlogPostsQuery = {
  ...
  allPosts: Array<{
    ...
    readTime?: any | null
    excerpt: string
    category: Array<{ __typename?: 'CategoryRecord'; id: any; name: string }>
  }>
...
export type CategoriesQuery = {
  __typename?: 'Query'
  allCategories: Array<{ __typename?: 'CategoryRecord'; id: any; name: string; path: string }>
}
...
export type BlogSearchQuery = {
  __typename?: 'Query'
  allPosts: Array<{ __typename?: 'PostRecord'; id: any; title: string; slug: string }>
}
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'PostModelFilter' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
export const BlogSearchDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'BlogSearch' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
...
} as unknown as DocumentNode<BlogSearchQuery, BlogSearchQueryVariables>
