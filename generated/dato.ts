...
export type BlogPostsQuery = { __typename?: 'Query', allPosts: Array<{ __typename?: 'PostRecord', id: string, title: string, slug: string, readTime?: number | null, excerpt: string, category: Array<{ __typename?: 'CategoryRecord', id: string, name: string }> }>, _allPostsMeta: { __typename?: 'CollectionMetadata', count: number } };

export type CategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type CategoriesQuery = { __typename?: 'Query', allCategories: Array<{ __typename?: 'CategoryRecord', id: string, name: string, path: string }> };
