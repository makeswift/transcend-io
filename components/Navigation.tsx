...
export function Navigation({ className, links, ctaText, ctaLink }: Props) {
  ...
  return (
    <>
      ...
      >
        <nav
          className={`mx-auto flex h-[70px] w-full max-w-[1296px] items-center px-5 md:px-8 lg:px-12 justify-between lg:justify-start ${
        ...
        >
          ...
          <div className="h-5 border-r border-[#ededf0] mx-8 hidden lg:block" />

          <NavigationMenu.Root className="z-[1] hidden lg:flex flex-1">
              ...
              {links?.map((link, i) => (
                <NavigationMenu.Item key={i} className="relative">
                  <NavigationMenu.Trigger
                    ...
                    } text-current group flex select-none items-center gap-[6px] py-5 text-sm font-bold leading-none outline-none`}
                  >
                    {link.text}{" "}
                    <svg
                      viewBox="0 0 7 5"
                            ...
                            <NavigationMenu.Link asChild>
                              ...
                              >
                                ...
                                <div className="flex-1 tracking-wide">
                                  <p className="text-[#515151] group-hover:text-[#3333ff] font-bold text-[18px] leading-[1.5]">
                                    {subnavLink.linkText}
                                  </p>

                                  {subnavLink.subtext && (
                                    <p className="text-[#717171] group-hover:text-[#3333ff] leading-[1.5]">
                                      {subnavLink.subtext}
                                    </p>
                                  )}
                                </div>
          ...
          <ul className="hidden lg:flex items-center gap-8 text-current text-sm font-bold leading-none">
            <li>
              <Link
              ...
              <li>
                <a
                  ...
                  className={`text-center tracking-wider rounded-lg border border-current px-5 py-2.5 transition-colors ${
                    sticky
                      ? "hover:text-current"
                      : "hover:bg-white hover:border-white hover:text-[#3333ff]"
                  } `}
                >
                  {ctaText}
                </a>
          ...
          >
            <svg
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              className="stroke-current w-[26px] h-6"
            >
              {mobileNavOpen ? (
